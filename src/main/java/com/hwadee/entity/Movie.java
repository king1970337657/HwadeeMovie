...
public class Movie {
	...
	public String toString() {
		return "Movie{" + "mid=" + mid + ", mname='" + mname + '\'' + ", maliasname='" + maliasname + '\''
				+ ", leadingactor='" + leadingactor + '\'' + ", language='" + language + '\'' + ", director='"
				+ director + '\'' + ", screenwriter='" + screenwriter + '\'' + ", filmlength=" + filmlength
				+ ", producer='" + producer + '\'' + ", coverimg='" + coverimg + '\'' + ", mscore=" + mscore
				+ ", realsetime=" + realsetime + ", mdesc='" + mdesc + '\'' + '}';
	}
}